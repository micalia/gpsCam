...
$(window).on("load", function() {
	...
	var MarkerOverlapRecognizer = function(opts) { //마커가 겹쳐지는걸 인식함.
	    ...
	    this._overlapListEl = $('<div style="position:absolute;z-index:100;margin:0;padding:0;display:block;border:1px solid blue;"></div>');//겹쳐진 리스트
	};
